...
export default function GuidedTour() {
  ...
  const steps = useMemo<TourStep[]>(() => [
    ...
    {
      selector: ".project-export-button",
      title: "Export show propre",
      body: "Le gestionnaire projet exporte un .glowproject avec show, patch, timeline, groupes, bibliotheque et snapshots pour transporter la regie proprement.",
    },
    {
      selector: ".project-import-button",
      title: "Import projet",
      body: "Avant d'importer, Glow Logic affiche un apercu avec compteurs et checks. C'est la zone a verifier avant de fusionner un show recu.",
    },
    {
  ...
  }, [addToast, setAppMode, setIsSidebarVisible, setIsTimelineVisible, setProView]);
  ...
  const measureTarget = useCallback(() => {
    ...
    if (step.selector.startsWith(".project-")) {
      setAppMode("smart");
      setProView("canvas");
      window.dispatchEvent(new Event("glowlogic:open-project-modal"));
    }
