...
function resolveProjectBlackout(state: any) {
    return Boolean(state?.blackout || state?.smartBlackout || false);
}
...
function normalizeImportedPack(rawPack: any) {
    ...
    const blackoutActive = resolveProjectBlackout(projectState);
    projectState.blackout = blackoutActive;
    projectState.smartBlackout = blackoutActive;
...
export const ProjectModal: React.FC<ProjectModalProps> = ({ onClose }) => {
    ...
    const handleExportPack = async () => {
        ...
        const blackoutActive = resolveProjectBlackout(state);
